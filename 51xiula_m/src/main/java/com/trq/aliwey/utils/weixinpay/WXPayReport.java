...
public class WXPayReport {
    ...
    public static class ReportInfo {
        ...
        // 针对主域�?
        private String firstDomain;  // �?次请求的域名
        private boolean primaryDomain; //是否主域�?
        private int firstConnectTimeoutMillis;  // �?次请求设置的连接超时时间，单�?毫秒
        private int firstReadTimeoutMillis;  // �?次请求设置的读写超时时间，单�?毫秒
        private int firstHasDnsError;  // �?次请求是否出现dns问题
        private int firstHasConnectTimeout; // �?次请求是否出现连接超�?
        private int firstHasReadTimeout; // �?次请求是否出现连接超�?
    ...
    private static String httpRequest(String data, int connectTimeoutMs, int readTimeoutMs) throws Exception{
        ...
        httpPost.addHeader("User-Agent", "wxpay sdk java v1.0 ");  // TODO: 很重要，用来�?�� sdk 的使用情况，要不要加上商户信息？
