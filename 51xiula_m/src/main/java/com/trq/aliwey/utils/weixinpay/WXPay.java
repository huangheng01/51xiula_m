...
import com.trq.aliwey.utils.weixinpay.WXPayConstants.SignType;
...
//        }
    ...
    /**
     * �?Map 中添�?appid、mch_id、nonce_str、sign_type、sign <br>
     * 该函数�?用于商户适用于统�?��单等接口，不适用于红包�?代金券接�?
     *
     * @param reqData
     * @return
     * @throws Exception
     ...
     * �?��证书的请�?
     * @param urlSuffix String
     * @param reqData 向wxpay post的请求数�? Map
     * @param connectTimeoutMs 超时时间，单位是毫秒
     * @param readTimeoutMs 超时时间，单位是毫秒
     * @return API返回数据
     * @throws Exception
     ...
     * @param readTimeoutMs 读超时时间，单位是毫�?
     * @return API返回数据
     * @throws Exception
     */
     ...
     * 作用：查询订�?br>
     * 场景：刷卡支付�?公共号支付�?扫码支付、APP支付
     * @param reqData 向wxpay post的请求数�?int
     * @param connectTimeoutMs 连接超时时间，单位是毫秒
     * @param readTimeoutMs 读超时时间，单位是毫�?
     * @return API返回数据
     * @throws Exception
