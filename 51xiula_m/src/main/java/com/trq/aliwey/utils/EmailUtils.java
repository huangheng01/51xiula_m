...
import com.trq.aliwey.utils.mail.EmailHandle;
...
public class EmailUtils {
	...
	private static String smtp = ConfigPropKit.get("mail.smtp.host"); //邮件协议
	private static String fromAddress = ConfigPropKit.get("mail.user.username"); //发送人地址
	private static String fromPass = ConfigPropKit.get("mail.user.password"); // 发送人密码
	 ...
	 * @throws Exception
	 */
	public static void send(String toAddress,String ccAdress, String subject, String content){
		try{
			System.out.println("开始向" + toAddress + "发送邮件");
			EmailHandle emailHandle = new EmailHandle(smtp);
			emailHandle.setFrom(fromAddress);
	 ...
	 * @throws Exception
	 */
	public static void send(String toAddress,String subject, String content,List<String> fileList){
		try{
			System.out.println("开始向" + toAddress + "发送邮件");
			EmailHandle emailHandle = new EmailHandle(smtp);
			emailHandle.setFrom(fromAddress);
	 ...
	 * @throws Exception
	 */
	public static void send(String toAddress,String ccAdress,String subject, String content,List<String> fileList){
		try{
			System.out.println("开始向" + toAddress + "发送邮件");
			EmailHandle emailHandle = new EmailHandle(smtp);
			emailHandle.setFrom(fromAddress);
