...
public class WXPayUtil {
    ...
    /**
     * 生成签名. 注意，若含有sign_type字段，必须和signType参数保持�?���?
     *
     * @param data 待签名数�?
     * @param key API密钥
     * @param signType 签名方式
    ...
    public static Map<String, String> parseXml(InputStream inputStream) throws Exception {
        ...
        Map<String, String> map = new HashMap<String, String>();// ���������洢��HashMap��
        SAXReader reader = new SAXReader();// ��ȡ������
        Document document = reader.read(inputStream);
        Element root = document.getRootElement();// �õ�xml��Ԫ��
        List<Element> elementList = root.elements();// �õ���Ԫ�ص������ӽڵ�
        for (Element e : elementList) {        // ���������ӽڵ�
