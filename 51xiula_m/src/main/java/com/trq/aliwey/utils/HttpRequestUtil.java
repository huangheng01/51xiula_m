...
public class HttpRequestUtil {
	...
	//接口地址
	private static String apiPath = ConfigPropKit.get("apiPath");
	...
	public static String sendGet(String url, String param, String token) {
		...
		try {
			String urlNameString = apiPath + url + "?" + param;
	...
	public static String sendPost(String url, String param, String token) {
		...
		String result = "";
		try {
			URL realUrl = new URL(apiPath + url);
			// 打开和URL之间的连接
	...
	public static void main(String[] args) {
		// 发送 GET 请求
		String s = sendGet("https://api.weixin.qq.com/cgi-bin/token", "grant_type=client_credential&appid=APPID&secret=APPSECRET", "");
